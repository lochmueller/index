...
{
    public function testInvokeDispatchesFinishIndexProcessEvent(): void
    {
        ...
        $subject = new FinishProcessHandler($eventDispatcher, $siteFinder);
        $subject->__invoke($message);

        self::assertInstanceOf(FinishIndexProcessEvent::class, $dispatchedEvent);
        ...
        self::assertIsFloat($dispatchedEvent->endTime);
    }
